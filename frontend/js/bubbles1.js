...
//Set up SVG and axis//
    var svg = d3.select("#songBrowserSvg");
    var digits = /(\d*)/;
    var margin = 50; //space in pixels from edges of SVG
    var padding = 4; //space in pixtels beween circles
    var maxRadius = 20;
    var biggestFirst = false; //should largest circles be added first?
